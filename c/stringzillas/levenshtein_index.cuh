...
sz_status_t szs_levenshtein_index_init_(                                //
    ...
    szs_levenshtein_index_t *index_punned, char const **error_message) noexcept {
    ...
    auto *index = new (std::nothrow) levenshtein_index_t;
    if (!index)
    ...
    *index_punned = reinterpret_cast<szs_levenshtein_index_t>(index);
...
SZ_API_RUNTIME sz_status_t szs_levenshtein_index_init(               //
    ...
    return szs_levenshtein_index_init_(sz_sequence_as_cpp_container_t {dictionary}, max_distance,
                                       deletion_max_word_length, alloc, index_punned, error_message);
}
...
SZ_API_RUNTIME sz_status_t szs_levenshtein_index_init_u32tape(       //
    ...
    szs_levenshtein_index_t *index_punned, char const **error_message) {
    sz_assert_(dictionary != nullptr && "Dictionary must not be null");
    return szs_levenshtein_index_init_(sz_sequence_u32tape_as_cpp_container_t {dictionary}, max_distance,
                                       deletion_max_word_length, alloc, index_punned, error_message);
}
...
SZ_API_RUNTIME sz_status_t szs_levenshtein_index_init_u64tape(       //
    ...
    szs_levenshtein_index_t *index_punned, char const **error_message) {
    sz_assert_(dictionary != nullptr && "Dictionary must not be null");
    return szs_levenshtein_index_init_(sz_sequence_u64tape_as_cpp_container_t {dictionary}, max_distance,
                                       deletion_max_word_length, alloc, index_punned, error_message);
}
